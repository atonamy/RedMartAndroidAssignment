...
public class ProductDetailsActivity extends AppCompatActivity implements RedMartService.ProductDetailsResult {
    ...
    public void onProductDetailsResponse(RedMartService.ProductDetails product_details) {
        ...
        productPrice.setText(currency.format(product_details.productInfo.normalPrice) + " " +
        ...
        {
            productPromoPrice.setText(currency.format(product_details.productInfo.promoPrice) + " " +
                getResources().getString(R.string.catalog_currency));
